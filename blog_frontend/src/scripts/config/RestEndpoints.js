...
export const ALL_ARTICLE = "/article/all";
export const LIKE_ARTICLE = "/article/like/";
export const ARTICLE_READ = "/article/read";
export const ARTICLE_SLUG = "/article/slug/";

export const COMMENT = "/comment/";
export const CREATE_COMMENT = "/comment";
export const ALL_COMMENT = "/comment/all";
export const LIKE_COMMENT = "/comment/like/";

export const NEWSLETTER = "/newsletter/";
export const CREATE_NEWSLETTER = "/newsletter";
export const ALL_NEWSLETTER = "/newsletter/all";

export const REPLY = "/reply/";
export const CREATE_REPLY = "/reply";
export const ALL_REPLY = "/reply/all";
export const LIKE_REPLY = "/reply/like/";

export const TAG = "/tag/";
export const CREATE_TAG = "/tag";
export const ALL_TAG = "/tag/all";
