...
class State extends BaseController {
  ...
  async get({ id }: any): Promise<void> {
    ...
    else this.status(true).statusCode(GET_SUCCESS).data('State', state).send()
  }
  ...
  async all() {
    ...
    else this.status(true).statusCode(GET_SUCCESS).data('states', states).send()
  }
  ...
  async create(obj: any): Promise<void> {
    ...
    else this.status(true).statusCode(POST_SUCCESS).message('State created').data('created', created).send()
  }
  ...
  async update(obj: any): Promise<void> {
    ...
    else this.status(true).statusCode(POST_SUCCESS).message('State updated').data('update', updated).send()
  }
  ...
  async delete({ id }: any): Promise<void> {
    ...
    else this.status(true).statusCode(POST_SUCCESS).message('State deleted').data('deleted', deleted).send()
  }
}
