...
class UserSetting extends BaseController {
  ...
  async get({ name, uid }: any) {
    ...
    else this.status(true).statusCode(GET_SUCCESS).data('userSetting', userSettingModel).send()
  }
  ...
  async all() {
    ...
    this.status(true).statusCode(GET_SUCCESS).data('userSettings', userSettings).send()
  }
  ...
  async reset({ uid }: any) {
    ...
    else this.status(true).statusCode(GET_SUCCESS).message('User setting reseted').data('settings', recreated).send()
  }
  ...
  async delete({ id }: any) {
    ...
    else this.status(true).statusCode(POST_SUCCESS).message('User setting deleted').data('deleted', deleted).send()
  }
}
