...
class Setting extends BaseController {
  ...
  async get({ id }: any) {
    ...
    else this.status(true).statusCode(GET_SUCCESS).data('setting', found).send()
  }
  ...
  async all() {
    ...
    else this.status(true).statusCode(GET_SUCCESS).data('settings', settings).send()
  }
  ...
  async create({ name, value, category }: any) {
    ...
    else this.status(true).statusCode(POST_SUCCESS).message('Setting created').data('created', created).send()
  }
  ...
  async update({ id, name, value, category }: any) {
    ...
    else this.status(true).statusCode(POST_SUCCESS).message('Setting updated').data('update', updated).send()
  }
  ...
  async delete({ id }: any) {
    ...
    else this.status(true).statusCode(POST_SUCCESS).message('Setting deleted').data('deleted', deleted).send()
  }
}
