...
class Countrie extends BaseController {
  ...
  async get({ id }: any): Promise<void> {
    ...
    else this.status(true).statusCode(GET_SUCCESS).data('countrie', countrie).send()
  }
  ...
  async all() {
    ...
    else this.status(true).statusCode(GET_SUCCESS).data('countries', countries).send()
  }
  ...
  async create(obj: any): Promise<void> {
    ...
    else this.status(true).statusCode(POST_SUCCESS).message('Countrie created').data('created', created).send()
  }
  ...
  async update(obj: any): Promise<void> {
    ...
    else this.status(true).statusCode(POST_SUCCESS).message('Countrie updated').data('update', updated).send()
  }
  ...
  async delete({ id }: any): Promise<void> {
    ...
    else this.status(true).statusCode(POST_SUCCESS).message('Countrie deleted').data('deleted', deleted).send()
  }
}
