...
class SettingCategory extends BaseController {
  ...
  async get({ id }: any) {
    ...
    else this.status(true).statusCode(GET_SUCCESS).data('settingCategory', found).send()
  }
  ...
  async all() {
    ...
    else this.status(true).statusCode(GET_SUCCESS).data('settingCategories', settingCategories).send()
  }
  ...
  async create({ name }: any) {
    ...
    else this.status(true).statusCode(POST_SUCCESS).message('Category created').data('created', created).send()
  }
  ...
  async update({ id, name }: any) {
    ...
    else this.status(true).statusCode(POST_SUCCESS).message('Category updated').data('update', updated).send()
  }
  ...
  async delete({ id }: any) {
    ...
    else this.status(true).statusCode(POST_SUCCESS).message('Category deleted').data('deleted', deleted).send()
  }
}
